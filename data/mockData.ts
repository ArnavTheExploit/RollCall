...
export const mockClasses: Class[] = [
  // ========== DEMO ONGOING CLASSES (All Day - Always Visible) ==========
  // These classes run from 6 AM to 10 PM to ensure they always appear as "ongoing"
  {
    id: "C_DEMO_IOT",
    ...
    startTime: "06:00",
    endTime: "22:00",
    duration: 960, // 16 hours (all day)
    studentIds: ["1", "2", "3", "4", "5", "6", "7", "8"],
    qrCode: `CLASS-DEMO-IOT-${formatDate(today)}-06:00`,
    createdAt: createDateWithTime(today, 5, 55).toISOString(),
    expiresAt: getEndTime(today, "06:00", 960).toISOString(),
    isActive: true,
  },
  {
    id: "C_DEMO_BLOCKCHAIN",
    ...
    duration: 960,
    studentIds: ["1", "2", "3", "4", "5", "6", "7", "8"],
    qrCode: `CLASS-DEMO-BLOCKCHAIN-${formatDate(today)}-06:00`,
    createdAt: createDateWithTime(today, 5, 55).toISOString(),
    expiresAt: getEndTime(today, "06:00", 960).toISOString(),
    isActive: true,
  },
  {
    ...
    duration: 960,
    studentIds: ["1", "2", "3", "4", "5", "6", "7", "8"],
    qrCode: `CLASS-DEMO-DEVOPS-${formatDate(today)}-06:00`,
    createdAt: createDateWithTime(today, 5, 55).toISOString(),
    expiresAt: getEndTime(today, "06:00", 960).toISOString(),
    isActive: true,
  },
  {
    ...
    duration: 960,
    studentIds: ["1", "2", "3", "4", "5", "6", "7", "8"],
    qrCode: `CLASS-DEMO-UIUX-${formatDate(today)}-06:00`,
    createdAt: createDateWithTime(today, 5, 55).toISOString(),
    expiresAt: getEndTime(today, "06:00", 960).toISOString(),
    isActive: true,
  },
  // Demo Ongoing Class (All Day)
  {
    ...
    duration: 960,
    studentIds: ["1", "2", "3", "4", "5", "6", "7", "8"],
    qrCode: `CLASS-CDEMO-${formatDate(today)}-06:00`,
    createdAt: createDateWithTime(today, 5, 55).toISOString(),
    expiresAt: getEndTime(today, "06:00", 960).toISOString(),
    isActive: true,
  },
...
export const mockAttendanceRecords: AttendanceRecord[] = [
  ...
  // Records for Cyber Security (C14)
  {
    id: "A9",
    classId: "C14",
  ...
  // Records for Ethical Hacking (C15)
  {
    id: "A13",
    classId: "C15",
  ...
  // Records for Artificial Intelligence (C12)
  {
    id: "A14",
    classId: "C12",
  ...
  // Records for Operating Systems (C2 - active today)
  {
    id: "A17",
    classId: "C2",
    className: "Operating Systems",
  ...
  // Records for Computer Networks (C6 - active today)
  {
    id: "A19",
    classId: "C6",
  ...
  // Records for Cloud Computing (C11 - active today)
  {
    id: "A22",
    classId: "C11",
  ...
  // Records for Database Management Systems (C3 - technically upcoming/not started, but adding for thoroughness if visible)
  {
    id: "A24",
    classId: "C3",
